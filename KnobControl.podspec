...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Julius Camba Abarra" => "iamjcabarra@gmail.com" }
  # Or just: spec.author    = "Julius Camba Abarra"
  # spec.authors            = { "Julius Camba Abarra" => "iamjcabarra@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Julius Camba Abarra"
...
spec.platform     = :ios, "12.0"
  ...
  spec.source       =  { :git => "https://github.com/iamjcabarra/KnobControl.git", :tag => "1.0.0" }
